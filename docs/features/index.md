...
| 工作区与项目作用域 | 通过 workspace/project 绑定约束任务可见范围与执行上下文 | 活跃 | 待定 | 2026-02-09 | [文档](workspace-project-scope.md) |
...
| crate/api-server | 提供 workspace/task/run/executor 的 Rust REST + Socket.IO 后端 | 活跃 | 待定 | 2026-02-09 | [文档](crate-api-server.md) |
...
| package/client | React 前端界面，提供 workspace 作用域任务看板与执行控制 | 活跃 | 待定 | 2026-02-09 | [文档](package-client.md) |
